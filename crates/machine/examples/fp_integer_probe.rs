...
fn run(kind: FloatConversionKind, value: u64, rounding_mode: u8) -> (u64, u64) {
    ...
    match kind {
        ...
        | FloatConversionKind::DFromWu => machine.x[1] = value,
    ...
    let result = match kind {
        ...
        FloatConversionKind::SFromW | FloatConversionKind::SFromWu => machine.f[2] & 0xffff_ffff,
        FloatConversionKind::DFromW | FloatConversionKind::DFromWu => machine.f[2],
        _ => unreachable!(),
    };
