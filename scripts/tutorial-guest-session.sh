...

{
    ...
    send 'assemble 0x80001000 addi x1,x0,1'
    send 'step'
    send 'regs'

    # Multi-line source, symbols and disassembly.
    send 'assemble-program 0x80010a30'
    send '_start:'
    send 'addi x1,x0,1'
    send 'beq x1,x1,next'
    send 'beq x1,x1,next'
    ...
    send 'assemble-program 0x81000100'
    send 'addi x1,x0,7'
    ...
    send 'assemble 0x80001000 fadd.s f3,f1,f2'
    send 'step'
    send 'regs'
    send 'setf f4 0x3ff0000000000000'
    send 'setf f5 0x4000000000000000'
    send 'assemble 0x80001000 fadd.d f6,f4,f5'
    send 'step'
    send 'regs'
