...
source_prompt_count() {
    grep -ao 'source> ' "$output_file" | wc -l
}
monitor_prompt_count() {
    grep -ao 'rvmonitor> ' "$output_file" | wc -l
}
payload_stream() {
...
printf 'DIM A$(2)\nDIM N(2)\nI=1\nLET A$(I+0)="DIRECT"\nLET N(I)=9\n10 LET S$="SCALAR"\n20 PRINT N(I),A$(I+0),S$\n30 DIM B$(2)\n40 LET B$(I+0)="PROGRAM"\n50 PRINT B$(I+0),S$\n60 END\nRUN\n' >&3
sleep 0.8
printf 'q\n' >&3
exec 3>&-
sleep 0.3
...
for expected in '9.000000' 'DIRECT' 'PROGRAM' 'trap: breakpoint'; do
