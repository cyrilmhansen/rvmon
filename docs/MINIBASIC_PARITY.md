...
| Horloge | `TIME` et `TIME$` target-side déterministes ; réglage de l’heure différé | PARTIEL | `test-guest-runtime-asm-repl-time.sh` sous QEMU : `TIME` renvoie `1.000000`, `TIME$` `000000` et la concaténation `T=000000` |
