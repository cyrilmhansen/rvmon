...
État de l’audit au 4 août 2026 : **126 scripts QEMU assembleur MiniBASIC
...
| 2026-08-04 | Audit de cohérence du registre | comptage reproductible : `find scripts -maxdepth 1 -type f -name 'test-guest-runtime-asm-repl*.sh' \| wc -l` → `126` | l’inventaire courant est distingué des comptes historiques ; les preuves de fonctions chaîne imbriquées, `HEX$`, `DEC`, `INKEY$` et `ERR/ERL` sont incluses |
