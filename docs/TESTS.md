...
| luna-app | 3 | Rappel borné des commandes host/QEMU avec `!!` et `!N`, références invalides et codes `APP-SHELL-*`; éditeur TTY crossterm, raccourcis `F5/F10/F11` et `Ctrl+1/2/3`; chemin script conservé. |
