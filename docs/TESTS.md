...
| luna-snapshot-format | 5 | Encode/decode RVSNAP01, CRC-32, limites de régions, corruption/troncature, collecte générique des blocs guest, application par patches 32 octets et refus des manifestes/chunks incohérents; export TCP QEMU réel vérifié par `scripts/test-guest-snapshot-export.sh`. |
