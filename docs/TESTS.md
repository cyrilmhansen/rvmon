...
| luna-snapshot-format | 4 | Encode/decode RVSNAP01, CRC-32, limites de régions, corruption/troncature, collecte générique des blocs guest et refus des manifestes/chunks incohérents; export TCP QEMU réel vérifié par `scripts/test-guest-snapshot-export.sh`. |
