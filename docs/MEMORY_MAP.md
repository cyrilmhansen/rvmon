...
| `0x82061600..0x82061eff` | pile des concaténateurs chaîne | 8 cadres de 288 octets : retour, total, buffer de concaténation et buffer source d'expression | appel target-side ; profondeur maximale 8 |
