...
| WVR-004 | ouvert | 14/14 scripts E2E guest/QEMU passent dans le dernier rapport historique (`E2E-REPORT.md`); le smoke de payload assembleur passe séparément, mais les scénarios SPEC 1–14 et la couverture seuil release ne sont pas réunis dans un rapport unique. | bloque la déclaration de release finale M9. |
